...
<details>
<summary><strong></strong>O que foi desenvolvido</strong></summary><br />

Um site que contém uma série de informações sobre o que você aprendeu aqui na Trybe ao longo de duas seções. O seu site deverá estar com elementos posicionados e estilizados e, além disso, deverá conter semântica apropriada para que seja acessível e melhor ranqueado.

💡Veja no exemplo a seguir como pode ser a aparência do projeto depois de pronto.
...
<summary><strong>Dependências</strong></summary><br />
  É necessário instalar as dependências com:<br>
  - `npm install`
  <br>
</details>
...
Para garantir a qualidade do código, foi utilizado neste projeto o linter `StyleLint`.
...
Configuração criada pela Trybe para este projeto.
</details>
...
<details>
<summary><strong>Links auxiliares utilizados para o desenvolvimento do projeto</strong></summary><br />
...
# Requisitos desenvolvidos do projeto:
